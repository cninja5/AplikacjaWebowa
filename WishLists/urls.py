...
urlpatterns = [
    ...
    path("edit-list/<int:idList>/edit-present/<int:idPresent>/", views.edit_present, name="edit_present"),
    ...
    path("deletePresent/<int:idList>/<int:idPresent>/", views.deletePresent, name="deletePresent"),
